...
/// Tracking tiket — menampilkan timeline perubahan status pada satu tiket.
/// SRS FR-011. Ticket id dikirim via `Get.arguments`.
...
class _TrackingScreenState extends State<TrackingScreen> {
  ...
  IconData _statusIcon(String status) {
    switch (status) {
      ...
      case 'assigned': return Icons.assignment_turned_in_outlined;
